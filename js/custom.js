jQuery(document).ready(function ($) {
  ...
  if (currentWidth <= 319) {
    ...
    $(".fixed-help-form-icon").click(function (e) {
      ...
      if ($this.hasClass("form-open")) {
        $("div.fixed-help-form").animate({ right: -200 }, function () {
          $this.removeClass("form-open");
          $this
            .parents(".fixed-help-form")
            .removeClass("helpform-wrapper-open");
        });
      } else {
        $("div.fixed-help-form").animate({ right: 0 }, function () {
          $this.addClass("form-open");
          $this.parents(".fixed-help-form").addClass("helpform-wrapper-open");
        });
      }
      e.preventDefault();
    });
    ...
    $(".fixed-help-form-icon").click(function (e) {
      var $this = $(this);
      if ($this.hasClass("form-open")) {
        $("div.fixed-help-form").animate({ right: -300 }, function () {
          $this.removeClass("form-open");
          $this
            .parents(".fixed-help-form")
            .removeClass("helpform-wrapper-open");
  ...
  $("a.dt-sc-toggle-practice").click(function (event) {
    ...
    $this
      .parents(".column")
      .find("div.dt-sc-practice-content")
        ...
        function () {
          ...
          if (
            ...
            var marginLeftFromContainer =
              containerMinuScreen + marginFromLeft + 20;
  ...
  $("select[name=cause]").change(function (event) {
    ...
    if ($(this).val() == "all") {
      ...
      $(".attorney_list .result-count").html(
        "Showing " + total_items + " of " + total_items
      );
    } else {
      ...
      $(".attorney_list .result-count").html(
        "Showing " + sorted_items + " of " + total_items
      );
    }
  });
});
