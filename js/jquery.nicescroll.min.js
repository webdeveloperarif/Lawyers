/* jquery.nicescroll 3.0.0 InuYaksa*2012 MIT http://areaaperta.com/nicescroll */ (function (
  d
) {
  var s = false,
    w = false,
    ...
    F = function (j, c) {
      ...
      function i(f, c) {
        ...
        if ("wheelDeltaY" in f)
          ...
          d &&
            (c
              ? (g = Math.floor(d * b.opt.mousescrollstep))
      ...
      this.ishwscroll =
        (this.canhwscroll = e.hastransform && b.opt.hwacceleration) &&
        b.haswrapper;
      this.istouchcapable = false;
      if (e.cantouch && e.ischrome && !e.isios && !e.isandroid)
        (this.istouchcapable = true), (e.cantouch = false);
      ...
      if (this.ishwscroll) {
        ...
        this.notifyScrollEvent = document.createEvent
          ...
          : function () {};
        e.hastranslate3d && b.opt.enabletranslate3d
        ...
        if (b.ishwscroll)
          ...
          if (b.railh && !b.locked)
            (g = c.top),
              ...
              b.railh.css({ top: f, left: e, width: b.railh.width });
        }
      };
        ...
        !(b.rail.drag && b.rail.drag.pt != 1) &&
          ...
          c
            ? ((c = g ? b.doScrollLeft : b.doScrollTop),
              (e = g
                ? (f.pageX - b.railh.offset().left - b.cursorwidth / 2) *
                  b.scrollratio.x
                : (f.pageY - b.rail.offset().top - b.cursorheight / 2) *
                  b.scrollratio.y),
              c(e))
            : ((c = g ? b.doScrollLeftBy : b.doScrollBy),
              (e = g ? b.scroll.x : b.scroll.y),
              (f = g
                ? f.pageX - b.railh.offset().left
                : f.pageY - b.rail.offset().top),
      ...
      this.init = function () {
        ...
        e.hasmstouch &&
          b.css(b.ispage ? d("html") : b.win, { "-ms-touch-action": "none" });
        if (!b.ispage || (!e.cantouch && !e.isieold && !e.isie9mobile)) {
          ...
          b.ispage &&
            ...
            (b.doc[0].nodeName == "BODY"
              ? b.css(d("html"), { "overflow-y": "hidden" })
              : b.doc[0].nodeName == "HTML" &&
                b.css(d("body"), { "overflow-y": "hidden" }));
          e.isios &&
            !b.ispage &&
            !b.haswrapper &&
            b.css(d("body"), { "-webkit-overflow-scrolling": "touch" });
          ...
          b.ispage
            ...
            : (b.ishwscroll
                ...
                : ((b.isfixed = b.win.css("position") == "fixed"),
                  ...
                  g.css({ position: f }),
                  b.zoom && b.zoom.css({ position: f }),
                  b.updateScrollBar(),
                  b.body.append(g),
                  b.zoom && b.body.append(b.zoom),
                  b.railh && (k.css({ position: f }), b.body.append(k))),
              e.isios &&
                b.css(b.win, {
          ...
          if (e.isie9mobile)
            (b.scrollmom = new z(b)),
              (b.onmangotouch = function () {
                var c = b.getScrollTop(),
                  f = b.getScrollLeft();
                if (
                  c == b.scrollmom.lastscrolly &&
                  f == b.scrollmom.lastscrollx
                )
                  return true;
                var g = c - b.mangotouch.sy,
                  e = f - b.mangotouch.sx;
                if (
                  Math.round(Math.sqrt(Math.pow(e, 2) + Math.pow(g, 2))) != 0
                ) {
                  var l = g < 0 ? -1 : 1,
                    d = e < 0 ? -1 : 1,
                    h = +new Date();
                  ...
                  if (
                    ...
                    (b.mangotouch.tm = h),
                    (g = Math.max(
                      Math.abs(b.mangotouch.ly - c),
                      Math.abs(b.mangotouch.lx - f)
                    )),
                    (b.mangotouch.ly = c),
                    (b.mangotouch.lx = f),
                    g > 2)
                ...
                if (!b.locked) {
                  ...
                  if (!e.cantouch && !this.istouchcapable && !e.hasmstouch) {
                    if (!f || !/INPUT|SELECT|TEXTAREA/i.test(f.nodeName))
                      return (
                        !b.ispage && e.hasmousecapture && f.setCapture(),
                        b.cancelEvent(c)
                      );
                    if (/SUBMIT|CANCEL|BUTTON/i.test(d(f).attr("type")))
                      (pc = { tg: f, click: false }), (b.preventclick = pc);
                  }
                }
              };
                ...
                if (b.rail.drag && b.rail.drag.pt == 2) {
                  ...
                  if (b.ishwscroll && b.opt.bouncescroll)
                    h < 0
                      ? (h = Math.round(h / 2))
                      : h > b.page.maxh &&
                        (h = b.page.maxh + Math.round((h - b.page.maxh) / 2));
                  else if ((h < 0 && (d = h = 0), h > b.page.maxh))
                    (h = b.page.maxh), (d = 0);
                  var i = c.clientX + g;
                  if (b.railh && b.railh.scrollable) {
                    ...
                    else if ((m < 0 && (i = m = 0), m > b.page.maxw))
                      (m = b.page.maxw), (i = 0);
                  }
                  b.synched("touchmove", function () {
                    b.rail.drag &&
                      ...
                      b.railh && b.railh.scrollable
                        ? (b.setScrollLeft(m), b.showCursor(h, m))
                        : b.showCursor(h),
            ...
            e.cantouch || b.opt.touchbehavior
              ? ((b.onpreventclick = function (c) {
                ...
                (b.onclick = e.isios
                  ...
                  : function (c) {
                      return b.lastmouseup
                        ? ((b.lastmouseup = false), b.cancelEvent(c))
                        : true;
                    }),
                ...
                e.cursorgrabvalue &&
                  ...
                  b.css(b.rail, { cursor: e.cursorgrabvalue })))
              : ((b.onmousedown = function (c, f) {
                ...
                (b.onmouseup = function (c) {
                  if (
                    ...
                    return (b.rail.drag = false), b.cancelEvent(c);
                }),
                (b.onmousemove = function (c) {
                  if (b.rail.drag) {
                    if (b.rail.drag.pt == 1) {
                      ...
                      if (b.rail.drag.hr) {
                        b.scroll.x =
                          b.rail.drag.sx + (c.clientX - b.rail.drag.x);
            ...
            b.railh &&
              (b.bind(b.cursorh, "mousedown", function (c) {
            ...
            b.opt.enablemousewheel &&
              (b.isiframe ||
                b.bind(
                  e.isie && b.ispage ? document : b.docscroll,
                  "mousewheel",
                  b.onmousewheel
                ),
          ...
          b.onkeypress = function (c) {
            ...
            if (
              ...
              switch (f) {
                ...
                case 63232:
                  b.railh &&
                    (g ? b.doScrollLeft(0) : b.doScrollLeftBy(72), (e = true));
                  break;
                case 39:
                case 63234:
                  b.railh &&
          ...
          if (!b.ispage && !b.haswrapper)
            "WebKitMutationObserver" in window
              ? ((b.observer = new WebKitMutationObserver(function (c) {
        ...
        if (this.doc[0].nodeName == "IFRAME") {
          var A = function () {
            ...
            b.opt.enablekeyboard &&
              b.bind(c, e.isopera ? "keypress" : "keydown", b.onkeypress);
            if (e.cantouch || b.opt.touchbehavior)
              b.bind(c, "mousedown", b.onmousedown),
                ...
                e.cursorgrabvalue &&
                  b.css(d(c.body), { cursor: e.cursorgrabvalue });
      ...
      this.onResize = function (c, e) {
        ...
        if (b.page.maxh == g && b.page.maxw == d && b.view.w == h)
          if (b.ispage) return b;
            ...
            if (
              b.lastposition &&
              ((d = b.lastposition), d.top == g.top && d.left == g.left)
            )
              return b;
            b.lastposition = g;
          }
      ...
      this._bind = function (c, e, g, d) {
        ...
        c.addEventListener
          ? c.addEventListener(e, g, d || false)
          : c.attachEvent
          ? c.attachEvent("on" + e, g)
          : (c["on" + e] = g);
      };
      this.bind = function (c, d, g, h) {
        ...
        i.addEventListener
          ? (e.cantouch &&
              /mouseup|mousedown|mousemove/.test(d) &&
              b._bind(
                i,
                d == "mousedown"
                  ? "touchstart"
            ...
            e.cantouch &&
              d == "mouseup" &&
              b._bind(i, "touchcancel", g, h || false))
          : b._bind(i, d, function (c) {
              if ((c = c || window.event || false) && c.srcElement)
                c.target = c.srcElement;
              return g.call(i, c) === false || h === false
                ? b.cancelEvent(c)
                : true;
            });
      };
      ...
      this.onmousewheel = function (c) {
        ...
        if (b.opt.preservenativescrolling && b.checkarea)
          (b.checkarea = false), (b.nativescrollingarea = b.isScrollable(c));
      ...
      b.opt.smoothscroll
        ? b.ishwscroll && e.hastransition && b.opt.usetransition
          ? ((this.prepareTransition = function (c, d) {
              ...
              if (!b.lasttransitionstyle || b.lasttransitionstyle != h)
                (b.lasttransitionstyle = h), b.doc.css(e.transitionstyle, h);
              return g;
            }),
        ...
        if ((c.speedy && b && c.speedy) || d) {
          ...
          var f = c.lastscrollx,
            ...
            g = function () {
              ...
              if (
                c.speedx &&
                ((f = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy))),
                (c.lastscrollx = f),
                f < 0 || f > n)
              )
                b = 0.1;
              ...
              c.demulxy < 1
                ? (c.timer = setTimeout(g, p))
                : (c.stop(), c.nc.hideCursor(), c.doSnapy(f, l));
            };
          g();
  ...
  (function (d, c, h) {
    ...
    v.prototype,
    "show,hide,onResize,resize,remove,stop,doScrollPos".split(","),
    function (d, c) {
      d[c] = function () {
        var d = arguments;
        return this.each(function () {
  ...
  d.fn.getNiceScroll = function (j) {
    return typeof j == "undefined"
      ? new v(this)
      : d.data(this[j], "__nicescroll") || false;
  };
  d.extend(d.expr[":"], {
