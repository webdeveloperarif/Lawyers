...
function animateSkillBars() {
  ...
  var applyViewPort = jQuery("html").hasClass("csstransforms")
    ? ":in-viewport"
    : "";
  jQuery(".dt-sc-progress" + applyViewPort).each(function () {
    ...
    progressBar
      ...
      .css(
        "background-color",
        progressBar.find(".dt-sc-bar").attr("data-bg-color")
      );
    ...
    if (!progressBar.hasClass("animated")) {
      ...
      progressBar
        .find(".dt-sc-bar")
        .animate({ width: progressValue + "%" }, 600, function () {
...
(function ($) {
  ...
  $(".dt-sc-counter").each(function () {
    $(this).bind("inview", function (event, visible) {
      var $this = $(this),
        $counter =
          $this.data("counter") !== undefined ? $this.data("counter") : "3000";
